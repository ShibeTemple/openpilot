...
QT_MOC_LITERAL(1, 25, 23), // "closeMapBoxInstructions"
QT_MOC_LITERAL(2, 49, 0), // ""
QT_MOC_LITERAL(3, 50, 22) // "openMapBoxInstructions"

    },
    "FrogPilotNavigationPanel\0"
    "closeMapBoxInstructions\0\0"
...
void FrogPilotNavigationPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotNavigationPanel::closeMapBoxInstructions)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FrogPilotNavigationPanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotNavigationPanel::openMapBoxInstructions)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FrogPilotNavigationPanel::closeMapBoxInstructions()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FrogPilotNavigationPanel::openMapBoxInstructions()
{
